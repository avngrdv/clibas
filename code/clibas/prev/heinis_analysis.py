...
if __name__ == '__main__':
    ...
    import config_heinis as config
    ...
    pip.enque([
                par.fetch_fastq_from_dir(), 
                par.translate(stop_readthrough=True),         
                ...
                par.cr_filter(where='pep', loc=[0, 2], tol=1),
